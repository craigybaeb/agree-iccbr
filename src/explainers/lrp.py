...
def linear_rule(rule=EpsilonRule):
    ...
    return SUPPORTED_LAYERS_WITH_RULES

def non_linear_support(activation):
    SUPPORTED_NON_LINEAR_LAYERS.append(activation)
    return SUPPORTED_NON_LINEAR_LAYERS
